...
export default function Page() {
  return (
    <PageLayout>
      ...
      <h1 className="text-4xl font-bold mb-2">Terms and Conditions of Property Agent Review Website</h1>

      Please read these terms and conditions carefully before using our property agent review website. By accessing or using our website, you agree to be bound by these terms and conditions. If you do not agree with any part of these terms and conditions, please refrain from using our website.

      <h2 className="text-2xl font-bold mb-2">Acceptance of Terms</h2>
      <p className="max-w-screen-desktop text-justify">
      1.1 By accessing or using our property agent review website (hereinafter referred to as "the Website"), you acknowledge that you have read, understood, and agreed to be bound by these terms and conditions, and any additional guidelines, rules, or policies referenced herein.
      ...
      <h2 className="text-2xl font-bold mb-2">User Obligations</h2>
      ...
      <h2 className="text-2xl font-bold mb-2">Property Agent Reviews</h2>
      <p className="max-w-screen-tablet text-justify">
      3.1 The Website provides a platform for users to submit reviews and ratings of property agents.
      ...
      <p className="max-w-screen-tablet text-justify">
      8.1 These terms and conditions shall be governed by and construed in accordance with the laws of [Jurisdiction]. Any dispute arising out of or in connection with these terms and conditions shall be subject to the exclusive jurisdiction of the courts of [Jurisdiction].
      </p>
